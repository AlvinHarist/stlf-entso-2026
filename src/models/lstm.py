"""
Standard (unidirectional) LSTM model for deterministic point forecasting.
...
def build_lstm(
    ...
    """Build and compile a single-layer LSTM for multi-step forecasting.
    ...
    dropout : float
        Dropout rate applied after the LSTM layer (0 = no dropout).
    learning_rate : float
